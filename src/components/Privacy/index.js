        ...
        <div id="inputResult">
          ...
          <div className="row mb-4">
            <div className="col">
              ...
              <span>
                ...
                персональных данных Касьянова Мария Гумаровна (далее –
                Оператор).
              </span>
              <p className="mb-4"></p>
              <ol>
                ...
                <li>
                  ...
                  веб-сайта{" "}
                  <a className="link mark" id="privacyURL" href="#prefixURL">
                    http://localhost:3000/#/
                  </a>
                  .
                </li>
            ...
            <div className="col">
              ...
              <ol>
                ...
                <li>
                  ...
                  адресу{" "}
                  <a className="link mark" href="#prefixURL">
                    http://localhost:3000/#/
                  </a>
                  ;
                </li>
          ...
          <div className="row mb-4">
            <div className="col">
              ...
              <p className="mb-4"></p>
              <ol id="dataTargetResult">
                <li>3.1. Фамилия, имя, отчество;</li>
                <li>3.2. Электронный адрес;</li>
                <li>
                  3.3. Также на сайте происходит сбор и обработка обезличенных
            ...
            <div className="col">
              ...
              <ol>
                ...
                <li>
                  ...
                  <a className="link mark" href="#privacyEmail">
